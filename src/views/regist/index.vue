	...
	<div class="login-container">
		<el-form autoComplete="on" :model="loginForm" :rules="loginRules" ref="loginForm" label-position="left" label-width="0px" class="card-box login-form">
          ...
          <icon-svg icon-class="mima" ></icon-svg>
				...
				<el-input name="ModifyPassword" type="password" v-model="modifyPas" autoComplete="on" placeholder="再次输入密码"></el-input>
			</el-form-item>
			<el-form-item>
			...
			<el-row>
				<el-col :span="24">
					<div class="grid-content bg-purple-dark bottom_tip" @click="goLogin">已有账号，去登录</div>
				</el-col>
			</el-row>
		</el-form>
	</div>
...
<script>
	...
	export default {
		...
		methods: {
			handleRegist() {
				if(this.modifyPas != this.loginForm.PassWord) {
					this.$message({
						message: '两次密码输入不同',
						type: 'warning'
					});
